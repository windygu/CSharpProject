...
using QRCodeImage = Whats.QRCode.Codec.Data.IQRCodeImage;
using QRCodeSymbol = Whats.QRCode.Codec.Data.QRCodeSymbol;
using ReedSolomon = Whats.QRCode.Codec.Ecc.ReedSolomon;
using DecodingFailedException = Whats.QRCode.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = Whats.QRCode.ExceptionHandler.InvalidDataBlockException;
using SymbolNotFoundException = Whats.QRCode.ExceptionHandler.SymbolNotFoundException;
using Point = Whats.QRCode.Geom.Point;
using QRCodeDataBlockReader = Whats.QRCode.Codec.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = Whats.QRCode.Codec.Reader.QRCodeImageReader;
using DebugCanvas = Whats.QRCode.Codec.Util.DebugCanvas;
using DebugCanvasAdapter = Whats.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = Whats.QRCode.Codec.Util.QRCodeUtility;

namespace Whats.QRCode.Codec
{
