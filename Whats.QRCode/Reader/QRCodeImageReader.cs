...
using Whats.QRCode.Codec.Data;
using AlignmentPatternNotFoundException = Whats.QRCode.ExceptionHandler.AlignmentPatternNotFoundException;
using FinderPatternNotFoundException = Whats.QRCode.ExceptionHandler.FinderPatternNotFoundException;
using SymbolNotFoundException = Whats.QRCode.ExceptionHandler.SymbolNotFoundException;
using InvalidVersionException = Whats.QRCode.ExceptionHandler.InvalidVersionException;
using VersionInformationException = Whats.QRCode.ExceptionHandler.VersionInformationException;
using Whats.QRCode.Geom;
using Whats.QRCode.Codec.Reader.Pattern;
using Whats.QRCode.Codec.Util;
using SystemUtils = Whats.QRCode.Codec.Util.SystemUtils;

namespace Whats.QRCode.Codec.Reader
{
	...
	public class QRCodeImageReader
	{
		...
		internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
		{
			...
			canvas.drawPoint(bottomRightPoint, Whats.QRCode.Codec.Util.Color_Fields.BLUE);
